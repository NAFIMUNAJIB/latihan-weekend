...
function showFakeLoadingForEmptyKhodam(name) {
  var emptyKhodamDescriptions = ["Anda tidak memiliki khodam, Khodam Anda masih dalam perjalanan ghaib menuju Anda"];
...
function generateKhodamDescription(name, khodamName) {
  ...
  const GROQ_API_KEY = "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";

  axios
    .post(
      "https://api.groq.com/openai/v1/chat/completions", // Menggunakan endpoint yang benar
      {
